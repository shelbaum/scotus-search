...
'Donohue', 'Dwyer', 'Engstrom', 'Fisher\\b', 'Fletcher', 'Ford', 'Franklin', 'Fried\\b', 'Friedman', 'Gilson', 
...
'Thompson', 'Triantis', 'Tyler', 'Schewick', 'Wald\\b', 'Weiner', 'Weisberg', 'Williams', 'Zambrano', 'Berman', 
